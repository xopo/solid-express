...
describe('mediaHelper', () => {
    describe('facebook', () => {
        it('should return the id from a facebook url', () => { 
            ...
            expect(result).toEqual({type: 'facebook', id: '10157009850766200'})
        })
        ...
        it('should retuern the id from facebook.com/.../videos/id url', () => {
            const url = 'https://www.facebook.com/100005024688471/videos/660233395853696/';
            const result = extractMediaMetaFromUrl(url);
    ...
    describe('rumble', () => {
        it('should return the id from a rumble url', () => { 
            const url = 'https://rumble.com/v4nadqz-big-conservative-media-spirals-tittle-tattle.html';
            const result = extractMediaMetaFromUrl(url);
